...
// 💡 Netlify Functions têm limite de payload (~10MB). Para upload de IMAGENS,
// prefira enviar direto para um provedor (Cloudinary/S3) via upload assinado
// e salve apenas a URL no banco. Se quiser usar Cloudinary, adicione as envs
// CLOUDINARY_URL ou chaves específicas e, no client, suba a imagem direto.
// Aqui mantemos apenas CSV via multipart.
